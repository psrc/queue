...
class InputConfig():
    ...
    spg_airport = {983: 101838}    # SeaTac demand (key = zone, value = demand)
    spg_general = {3110: 1682,    # Three special generators as defined in SPECIAL_GENERATORS (key = zone, value = demand)
                   631: 7567, 
                   438: 14013}    
